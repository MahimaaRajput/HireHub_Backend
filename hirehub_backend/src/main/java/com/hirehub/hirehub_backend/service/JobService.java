...
public interface  JobService {
    ...
    List<JobDto> filterJobs(Long minSalary, Long maxSalary, String experience, 
                           String location, String jobType, String category, com.hirehub.hirehub_backend.enums.WorkMode workMode, com.hirehub.hirehub_backend.enums.ShiftTiming shiftTiming, LocalDateTime startDate, LocalDateTime endDate);
